...
def get_args():
    ...
    parser.add_argument("--modelPath", default="./epoch 218_ssim 0.892429_psnr 28.471506")
...
def run_test(input_dir, outout_dir, args):
    with torch.no_grad():
        ...
        for image_name in os.listdir(input_dir):
            ...
            print("Now is processing the image name " + image_name)
            im = cv2.imread(image_file).astype("uint8")
            ...
            detail = im - result
            detail_enhance = result + detail*2
            detail_enhance = np.clip(detail_enhance, 0, 255).astype("uint8")
            out_image_name = outout_dir + image_name[:-4] + '_CSGIS-Net2.png'
            cv2.imwrite(out_image_name, detail_enhance)
            print("........................................")
